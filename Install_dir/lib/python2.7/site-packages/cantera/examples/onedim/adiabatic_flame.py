...
#initial_grid = [0.0, 0.001, 0.01, 0.02, 0.029, 0.03] 
tol_ss = [1.0e-13, 1.0e-13]  # [rtol atol] for steady-state problem
tol_ts = [1.0e-13, 1.0e-13]  # [rtol atol] for time stepping
